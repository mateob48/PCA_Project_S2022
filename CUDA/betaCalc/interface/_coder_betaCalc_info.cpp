...
//
// _coder_betaCalc_info.cpp
//
// Code generation for function 'betaCalc'
//

// Include files
#include "_coder_betaCalc_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"betaCalc"));
      ...
      emlrtMxCreateString(
          (const char_T
               *)"C:\\Users\\mateo\\OneDrive\\Documents\\Mateo\\Project "
                 "PAC\\Code\\CUDA\\betaCalc.m"));
  emlrtSetField(xEntryPoints, 0, (const char_T *)"TimeStamp",
                emlrtMxCreateDoubleScalar(738606.53085648152));
  xResult =
...
// End of code generation (_coder_betaCalc_info.cpp)
