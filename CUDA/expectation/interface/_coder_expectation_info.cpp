...
//
// _coder_expectation_info.cpp
//
// Code generation for function 'expectation'
//

// Include files
#include "_coder_expectation_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"expectation"));
      ...
      emlrtMxCreateString(
          (const char_T
               *)"C:\\Users\\mateo\\OneDrive\\Documents\\Mateo\\Project "
                 "PAC\\Code\\CUDA\\expectation.m"));
  emlrtSetField(xEntryPoints, 0, (const char_T *)"TimeStamp",
                emlrtMxCreateDoubleScalar(738617.93575231486));
  xResult =
...
// End of code generation (_coder_expectation_info.cpp)
