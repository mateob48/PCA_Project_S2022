function [Total_F,Total_M,ObsF,ObsM,trainF,testF,trainM,testM]=load_total_data()
...
trainF = NewF(1:10000,:);% training X vector with 250 values 
testF = NewF(10001:20000,:);% testing X vector with 250 values
trainM = NewM(1:10000,:);% training X vector with 250 values 
testM = NewM(10001:20000,:);% testing X vector with 250 values
end