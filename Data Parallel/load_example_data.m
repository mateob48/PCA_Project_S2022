function [Total_Obs,Obs,trainD,testD]=load_example_data(up1, up2)
...
trainD = NewX(1:up1,:);% training X vector with 250 values 
testD = NewX(up1+1:up2,:);% testing X vector with 250 values
end
