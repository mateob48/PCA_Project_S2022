% Specify the data at the beginning of the execution to determine the
% experiment that it is being performed
NumTrain = 6;
HiddenStates = 5;
up1 = 5000;
up2 = 10000;
...
parfor i = 1:NumTrain
    [max_ind,delta,prb,tEnd2]=viterbi_alg(testStruct{i},MuT,CovT,PiT,TransT);
